...
public class KCalSettings extends PreferenceFragment implements
        ...
        switch (key) {
            ...
            case PREF_SATURATION:
                if (!(Settings.Secure.getInt(getContext().getContentResolver(), PREF_GRAYSCALE, 0) == 1)) {
                    PartsUtils.setValue(KCAL_SAT, (int) value + SATURATION_OFFSET);
                }
                break;

            case PREF_VALUE:
                PartsUtils.setValue(KCAL_VAL, (int) value + VALUE_OFFSET);
                break;

            case PREF_CONTRAST:
                PartsUtils.setValue(KCAL_CONT, (int) value + CONTRAST_OFFSET);
                break;

            case PREF_HUE:
                PartsUtils.setValue(KCAL_HUE, (int) value);
                break;
    ...
    void setmGrayscale(boolean checked) {
        ...
        PartsUtils.setValue(KCAL_SAT, checked ? 128 :
